...
declare module 'artifactory-tasks-utils' {
    export function executeCliTask(runTaskFunc: (cliPath: string) => void, cliVersion?: string,
                                   cliDownloadUrl?: string, cliAuthHandlers?: ifm.IRequestHandler[]): void;
    export function quote(str: string): string;
    export function downloadCli(cliDownloadUrl?: string, cliAuthHandlers?: ifm.IRequestHandler[],
                                cliVersion?: string): Promise<string>;
    ...
    export function createBuildToolConfigFile(cliPath: string, artifactoryService: any, cmd: string,
                                              requiredWorkDir: string, configCommand: string, repoResolver: string,
                                              repoDeploy: string): string[];
}